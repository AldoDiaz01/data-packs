...
# # Advancements relating to naming things
execute as @e[name=Dinnerbone,tag=!bac_name_checked] at @s run function blazeandcave:whats_up_doc
execute as @e[name=Grumm,tag=!bac_name_checked] at @s run function blazeandcave:whats_up_doc
execute as @e[type=rabbit,name=Toast,tag=!bac_name_checked] at @s run function blazeandcave:i_just_want_to_make_toast
execute as @e[type=sheep,name=jeb_,tag=!bac_name_checked] at @s run function blazeandcave:nyan_sheep
